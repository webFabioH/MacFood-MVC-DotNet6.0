            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adress = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Adress2 = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    SendOrder = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    DeliveredOrderIn = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
